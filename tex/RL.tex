...
\begin{align*}
    \pi (a \mid s; \theta ) 
    \qquad \qquad \qquad \qquad \text{from Distribution to Network} 
\end{align*}
~ \\[3pt]
(2)Optimal Policy: (!= Optimal Values) 
\begin{align*}
    \max_{\theta} \ metric[ \pi (a \mid s; \theta ) ] 
\end{align*}
~ \\[3pt]
(3)Distribution(d): 
\begin{align*}
    d \ is \ not \ related \ with \ \pi &: Uniform \ Distribution \\[3pt]
    d \ is \ related \ with \ \pi &: Stable \ Distribution \\[3pt]
\end{align*}
